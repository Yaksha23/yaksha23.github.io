...
N[O].b(N[O])&&(U(b.width-100,120,"complete!","#FF0",!0),S=1,C=B=0),k=0,l=p,r=!0,ha=y=z=t=0,D=!1,E=0),u-=d,ea-=d,0>=u&&(u=1+3*Math.random(),ea=.1+.1*Math.random()));a=280/Math.max(k,280)*1.5;I=a<H?3:I-d;a=Math.min(H,a);.5>a&&(a=Math.pow(a,.97));H+=.2*(a-H);0>=I&&(H+=.001*(.7-H));J*=.8;F*=.9;G+=4E3*d;c.save();c.setTransform(1,0,0,1,0,0);c.fillStyle="#FFF5E0";c.fillRect(0,0,b.width,b.height);c.restore();c.save();c.scale(H+J,H+J);e=b.width/(H+J);aa=b.height/(H+J);c.translate(.5*(e-b.width),aa-b.height);
c.save();c.translate(.5*b.width,b.height-120);X(e,240,"#FF6969");Y(-196,-20,-196,80,12);Y(196,-20,196,80,12);c.translate(0,Math.sin(G*Math.PI/180)*F);Y(-200,0,200,0,12);c.restore();c.save();c.translate(.5*b.width+h,b.height-170-k);c.rotate(m*Math.PI/180);c.translate(0,-40);X(80,96,"#C70039");c.save();0<ea||v?(c.translate(-4,4),X(40,40,"#000"),c.translate(4,4),X(34,34,"#FF9600"),c.translate(-12,0)):(c.translate(-4,4),X(40,40,"#FFF"),c.translate(-8,4-7*Math.max(Math.min(l/1E3,1),0)),X(16,24,"#000"));
